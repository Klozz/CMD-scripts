...
For %%a in ( 0x0003 0x000A 0x000B 0x000E 0x0013
             0x0016 0x0017 0x1002 0x1003 0x1004
             0x1005 0x1006 0x1007 0x1008 0x100A
             0x100B 0x100C 0x1010 0x1011 0x1012
             0x1013 0x1014 0x1015 0x101E 0x101F
             0x1040 0x1047 0x1048) Do ( REM INT32 UINT32
  If !Type! EQU %%a ( Call :toInt result !@! 8 & Goto :print)
)
For %%a in ( 0x0014 0x0015) Do ( REM INT64 UINT64
